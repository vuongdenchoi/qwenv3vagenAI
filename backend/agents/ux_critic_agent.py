    ...
    def generate_critique(
        ...
        if lang == "vi":
            system_prompt += (
                ...
                '       "fix_recommendation": "Chuyển chữ sang màu trắng hoặc vàng sáng để tăng độ tương phản rõ rệt."\n'
                '     },\n'
                '     {\n'
                ...
                '       "fix_recommendation": "Giảm độ mờ (opacity) của dòng chữ này xuống còn 15-20% hoặc chuyển chữ ra phía sau nhân vật chính."\n'
                '     }\n'
                '  ],\n'
                '  "validated_errors": [\n'
                '     {\n'
