...
def process(filepath):
    ...
    # Need to remove the redundant actual_lang assignment around line 913 since we moved it to top
    content = content.replace("actual_lang = lang if lang else detect_feedback_language(msg)\n", "")
